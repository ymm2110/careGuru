<scenarioselection>
  <div class="home-wrap" if={!scenarioSelection}>
    <senario each = {i in currentScenario} data = {i}></senario>
    <div class="button-wrap">
      <button onclick={option} id={i.scenarioLinkTo} each={i in="in" currentScenario.scenarioName}="currentScenario.scenarioName}">{i.scenarioName}</button>
    </div>
...
<script>
  ...
  this.scenarioData = [
    ...
    },
    {
      ...
      scenarioIntroduction: "Scenario 2 Intro -- Need update",
      scenarioContent: {
        question: "As George, what should you do?",
        descrip: "Scenario 2 descrip -- Need update",
        imgurl: "sadsadada",
        sceneId: 1,
        options: {
          option1: {
    ...
    },
    {
      ...
      scenarioIntroduction: "Scenario 3 Intro -- Need update",
      scenarioContent: {
        question: "As George, what should you do?",
        descrip: "Scenario 3 descrip -- Need update",
        imgurl: "sadsadada",
        sceneId: 1,
        options: {
          option1: {
